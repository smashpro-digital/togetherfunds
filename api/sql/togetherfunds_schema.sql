...
CREATE TABLE IF NOT EXISTS spd_tf_user_couple_links (
  ...
  CONSTRAINT fk_spd_tf_user_couple_links_couple FOREIGN KEY (couple_id) REFERENCES spd_tf_couples(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS spd_tf_couple_invites (
  ...
  CONSTRAINT fk_spd_tf_invites_couple FOREIGN KEY (couple_id) REFERENCES spd_tf_couples(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
